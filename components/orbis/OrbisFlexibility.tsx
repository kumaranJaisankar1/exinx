  ...
  return (
    <section className="py-24 bg-white dark:bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="bg-[#0E76BD]/5 rounded-[4rem] p-12 md:p-24 border border-[#0E76BD]/10 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <h2 className="mb-8 flex flex-col items-start gap-2">
                <span className="hero-title-thin text-3xl md:text-4xl">Flexible and</span>
              ...
              <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed font-light mt-6">
