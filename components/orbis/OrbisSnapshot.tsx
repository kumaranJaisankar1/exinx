      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <span className="font-mono text-[10px] tracking-[0.5em] uppercase text-[#0E76BD] mb-8 block">
              Feature Snapshot
            </span>
            <h2 className="mb-16 flex flex-col items-start gap-2">
              <span className="hero-title-thin text-3xl md:text-4xl text-white/60">
                Comprehensive
              </span>
              <span className="hero-title-bold text-4xl md:text-6xl text-white">
                Feature Set
              </span>
            </h2>
